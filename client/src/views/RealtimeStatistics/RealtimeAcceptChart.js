...
export default class RealtimeAcceptChart extends React.Component {
    ...
    getFilterOption = () => {
        const { queryRealtimeData, x_filter_data1, x_filter_data2 } = this.props.store,
            ...
            optionData = option.getAcceptData(currentRealtimeStatusData, lastRealtimeStatusData, x_filter_data1, x_filter_data2),
    ...
    getAllInternalOption = () => {
        const { queryRealtimeData, x_week_data1, x_week_data2 } = this.props.store,
            ...
            optionData = option.getAcceptData(currentInternalStatusData, lastInternalStatusData, x_week_data1, x_week_data2),
            x_current_data = optionData[0],
            x_last_data = optionData[1],
            y_current_data = optionData[2],
            y_last_data = optionData[3],
    ...
    getAllTransnationalOption = () => {
        const { queryRealtimeData, x_week_data1, x_week_data2 } = this.props.store,
            ...
            optionData = option.getAcceptData(currentTransnationalStatusData, lastTransnationalStatusData, x_week_data1, x_week_data2),
            x_current_data = optionData[0],
            x_last_data = optionData[1],
            y_current_data = optionData[2],
            y_last_data = optionData[3],
    ...
    render() {
        ...
        if (queryRealtimeData.length === 4) {
            ...
            if (refName === 'realtimeInternalAcceptChart') {
