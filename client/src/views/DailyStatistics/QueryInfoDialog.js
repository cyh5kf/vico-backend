...
class TheForm extends React.Component {
    ...
    componentDidMount() {
        ...
        if(formValues) {
            formValues.range_time_picker[0] = moment(formValues.range_time_picker[0]);
            formValues.range_time_picker[1] = moment(formValues.range_time_picker[1]);
            ...
            <Form layout="horizontal">
                ...
                >
                    {getFieldDecorator('range_time_picker', {
                        ...
                        <RangePicker format="YYYY-MM-DD" ranges={{ Today: [moment(), moment()], 'This Week': [moment().subtract(7, 'days'), moment()] }} />
                        )}
                </FormItem>
    ...
    handleOk = () => {
        ...
        theForm.validateFields((err, fieldsValue) => {
            ...
            const values = {
                ...fieldsValue,
                'range_time_picker': [
                    rangeTimeValue[0].valueOf(),
                    rangeTimeValue[1].valueOf()
                ]
            };
            actions.handleQueryDaily(values, () => {
